  ...
  return (
    <main className="bg-[#F9FAFB] text-[#0A3D79]">
      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        <Image
          src="/image/hero-factory.webp"
          alt="Garment Manufacturing Unit"
          fill
          priority
          sizes="100vw"
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              India’s Premier Garment Manufacturer
            </h1>
            <p className="text-white/90 text-lg mb-10 max-w-2xl mx-auto">
              From design to delivery — The Garment Guy turns global fashion ideas into
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: "Our multi-stage inspections ensure flawless output every time.",
            },
            {
              icon: <Leaf size={36} />,
              title: "Sustainability",
              desc: "We prioritize eco-friendly materials and ethical labor practices.",
            },
          ].map((item) => (
            <motion.div
              key={item.title}
            ...
            >
              <div className="text-[#0A3D79] mb-4 flex justify-center">
                {item.icon}
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              brands with world-class garment production in India. We specialize in
              transforming design concepts into production-ready collections.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Our focus lies in craftsmanship, reliability, and ethical operations.
              Every garment produced reflects precision and passion — ensuring
              sustainability without compromising quality.
            </p>
            <p className="text-gray-700 leading-relaxed">
              We empower startups and established labels to scale seamlessly with
              transparency, trust, and innovation at every step.
            </p>
          </div>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: "Collaborate with our design team to finalize your vision.",
            },
            {
              step: 2,
              title: "Fabric Sourcing",
              desc: "We source high-grade, sustainable fabrics for every style.",
            },
            {
              step: 3,
              title: "Cutting & Stitching",
              desc: "Skilled artisans ensure precision and durability in every stitch.",
            },
            {
              step: 4,
              title: "Quality Check",
              desc: "Each piece undergoes a rigorous multi-point inspection.",
            },
            {
              step: 5,
              title: "Packaging & Delivery",
              desc: "We pack with care and ship globally, on time.",
            },
          ].map(({ step, title, desc }) => (
            <motion.div
              key={step}
            ...
            >
              <div className="text-blue-800 text-2xl font-bold mb-2">{step}</div>
          ...
          {[
            {
              ...
              quote:
                "The Garment Guy exceeded our expectations — unmatched quality and clear communication.",
            },
            {
              name: "Priya S.",
              role: "Label Owner, India",
              quote:
                "A reliable partner who helped us scale production effortlessly while maintaining premium quality.",
            },
            {
              name: "Marco L.",
              role: "Creative Director, Italy",
              quote:
                "Their transparency and process efficiency helped us expand our fashion line confidently.",
            },
          ].map(({ name, role, quote }) => (
            <motion.div
              key={name}
